		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#isidyconnecttoodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"isidyconnecttoodata-display": {
								"semanticObject": "isidyconnecttoodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=isid.yconnecttoodata",
									"url": sap.ui.require.toUrl("isid/yconnecttoodata")
								}
							}
						}
					}
